...
#include <string>
using namespace std;
const double sheepneed = 0.11, horseneed = 0.068, cowneed = 0.086;//water in L per 1 kg
class FarmAnimal {
public:
...
int main() {
	...
	do
	{
		...
		{
			//parse string to find the animal's weight and parse it to double
			//5 - the "sheep" word length, 6 = length + 1
