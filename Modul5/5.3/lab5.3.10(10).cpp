...
int main()
{
	...
	cout << "Input please the 1-st point's coordinates(for constructing line): ";
	cin >> x1 >> y1;
	cout << "Input please the 2-st point's coordinates(for constructing line): ";
	cin >> x2 >> y2;
	cout << "Input please the point's coordinates: ";
	cin >> x3 >> y3;
